...
//    }
    ...
    public SearchBuilder matchCase(Map<String, String> properties) {
        String value = properties.get(SearchBuilder.MATCH_CASE);
        if (value != null)
            matchCase = Boolean.parseBoolean(value);
        return this;
    }
    ...
    public SearchBuilder matchAll(Map<String, String> properties) {
        String value = properties.get(SearchBuilder.MATCH_ALL);
        if (value != null)
            matchAll = Boolean.parseBoolean(value);
        return this;
    }
    ...
    private Predicate<AbstractFile> createFilenamePredicate() {
        ...
        if (!matchCase) {
            ...
            return file -> file.getName().toLowerCase().contains(searchStr);
        }

        return file -> file.getName().contains(searchStr);
    }
